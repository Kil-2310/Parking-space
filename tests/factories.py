...
class ClientFactory(factory.alchemy.SQLAlchemyModelFactory):
    ...
    car_number = factory.LazyAttribute(
        lambda x: f"{random.choice(['А', 'В', 'Е', 'К', 'М', 'Н', 'О', 'Р', 'С', 'Т', 'У', 'Х'])}{random.randint(1, 9)}{random.randint(0, 9)}{random.randint(0, 9)}{random.choice(['А', 'В', 'Е', 'К', 'М', 'Н', 'О', 'Р', 'С', 'Т', 'У', 'Х'])}{random.randint(1, 9)}{random.randint(0, 9)}"
    )
